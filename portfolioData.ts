...
const nullFundamentals = (): Fundamentals => ({
  ...
  projectedGrowthPct: null, actualGrowthPct: null,
});

const nullValuation = (): Valuation => ({
  pe: null, evEbitda: null, priceToSales: null,
});

const nullRisk = (): RiskMetrics => ({
  volatilityPct: null, beta: null, maxDrawdownPct: null,
});

const nullQualitative = (): QualitativeData => ({
  thesis: null, whatNeedsToGoRight: null,
  sellCriteria: null, catalysts: null,
});
